...
const page = () => {
    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2'>
            <img src="https://static.vecteezy.com/system/resources/previews/021/666/231/original/3d-rendering-of-a-customer-service-illustration-call-center-online-customer-support-contact-us-customer-service-for-personal-assistant-service-3d-rendering-png.png" alt="" />
            <div>
                ...
                <form onSubmit={submitContact}>
                    ...
                    <input className='w-full py-2 bg-yellow-500 rounded-sm shadow-sm mt-3 font-bold text-white' type="submit" value="Message Sent" />
                </form>
            </div>
        </div>
    );
